    ...
    <DayPicker
      ...
      classNames={{
        ...
        button_previous: cn(
          ...
          "size-(--cell-size) aria-disabled:opacity-50 p-0 select-none text-white hover:bg-white/10 hover:text-gold-accent",
        ...
        today: cn(
          "bg-white/10 text-gold-accent rounded-md data-[selected=true]:rounded-none",
